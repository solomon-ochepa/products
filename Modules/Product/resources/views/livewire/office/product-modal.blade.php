<div wire:ignore.self class="modal fade modal-quick-view" id="product-modal" data-bs-backdrop="static"
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title product-title">
                    <i class="fa-solid {{ isset($product->id) ? 'fa-edit' : 'fa-plus-circle' }} icon me-1"></i>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="barcode" id="barcode" class="form-control"
                                                    placeholder="Barcode" aria-label="Barcode"
    ...
    @push('js')
        <script>
            document.addEventListener('product:edit', function() {
                $(function() {
